...
// Create ServiceCall
serviceCallRouter.post("/", authenticateRoleMiddleWare(["EMPLOYEE"]), async (req, res) => {
  try {
...
// Read ServiceCall
serviceCallRouter.get("/:id", authenticateRoleMiddleWare(["ADMIN"]), async (req, res) => {
  try {
...
// Update ServiceCall
serviceCallRouter.put("/:id", authenticateRoleMiddleWare(["ADMIN"]), async (req, res) => {
  try {
...
// Delete ServiceCall
serviceCallRouter.delete("/:id", authenticateRoleMiddleWare(["ADMIN"]), async (req, res) => {
  try {
    const id = Number(req.params.id);
...
// Search ServiceCall
serviceCallRouter.get("/search/:searchString", authenticateRoleMiddleWare(["ADMIN"]), async (req, res) => {
  try {
