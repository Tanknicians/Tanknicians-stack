...
describe("Authentication API", () => {
  test("should login user", async () => {
    ...
    await request(app).post("/api/auth/login").send(mockReq.body);
  ...
  test("should register user", async () => {
    ...
    await request(app).post("/api/auth/register").send(mockReq.body);
  ...
  */
  ...
  test("should refresh token", async () => {
    ...
    await request(app).post("/api/auth/refresh").send(mockReq.body);
