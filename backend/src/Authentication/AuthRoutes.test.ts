...
describe("Authentication API", () => {
  test("should login user", async () => {
    ...
    const mockReq = {
      body: { email: "testemail@gmail.com", password: "hunter2" },
    };
  ...
  */
  ...
  test("should refresh token", async () => {
    ...
    const mockReq = {
      body: {
        refreshToken:
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..bu27cOIk3DGdpIQWnqBWWQMw44oq5pKgle5ErxGvp4c",
      },
    };
    const mockRes = { status: jest.fn(), json: jest.fn() };
