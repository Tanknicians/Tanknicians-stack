...
export default function Clients() {
  return (
    <div style ={{maxWidth: '1000px', justifyContent: 'center'}}>
      ...
      <Box sx={{ flexGrow: 1, display: 'flex', padding: '20px', }}>
        <Grid container spacing={2} >
          <Grid item xs={12} sm={2} sx={{...headerGridStyle, }}>
            <Typography color='inherit' variant='h4' component='h1'>
              Clients
            </Typography>
          </Grid>
          <Grid item xs={6} sm={8} sx={{...headerGridStyle, }}>
          <Container maxWidth="sm">
              <UserSearchBar optionsList={client} handleUserSelected = {searchBarInput}/>
          </Container>
          </Grid>
          <Grid item xs={6} sm={2} sx={{...headerGridStyle, }}>
